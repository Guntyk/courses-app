...
export const logoutUser = () => coursesApi.delete(`/logout`);


//* Courses
export const getCourses = (params) => coursesApi.get('/courses/all', { params });
...
//* Authors
export const getAuthors = (params) => coursesApi.get('/authors/all', { params });
